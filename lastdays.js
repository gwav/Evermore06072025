...
Hooks.once("init", function() {
    ...
    CONFIG.lastdays = {
        configuration: {
            inventoryItemTypes: {
                "weapon": "ldoa.itemTypes.weapon",
                "armor": "ldoa.itemTypes.armor",
                "shield": "ldoa.itemTypes.shield",
                "container": "ldoa.itemTypes.container",
                "consumable": "ldoa.itemTypes.consumable",
                "other": "ldoa.itemTypes.other"
            },
        }
    };
